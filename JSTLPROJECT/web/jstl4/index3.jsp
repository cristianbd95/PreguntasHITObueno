 ...
 <script>
            function envia(id) {
                var element = document.getElementById(id);
                   ...
                   form.txhNombre.value = element.id;
                   form.boton.value = "Aceptar";
                   form.submit();
            }
</script>

          <form action="index3.jsp" id="formulario" method="post">
            <input type="hidden" name="txhNombre" id="nombre">
            <input type="hidden" name="txhBoton" id="boton">
            <td><h3 id="<%=med.getNombre()%>" onclick="javaScript:envia(this.id);">Ver Datos</h3></td>
          </form>  
<%
